...
#define USBD_PRODUCT_HS_STRING        "test1"
#define USBD_SERIALNUMBER_HS_STRING   "00000000011C"

#define USBD_PRODUCT_FS_STRING        "HOBO U12-006 4-Channel Ext"
#define USBD_SERIALNUMBER_FS_STRING   "1286142"
